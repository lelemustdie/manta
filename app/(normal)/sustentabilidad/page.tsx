...
export default function Sustentabilidad() {
    ...
    return (
        <>
            <div className="relative h-96"><h1 className="text-center mt-40 text-6xl text-white bg-transparent">Sustentabilidad</h1>
                <Video
                    src="/sustentabilidad.mp4"

                />
            </div>


            <section className="bg-manta-light-grey text-manta-black-grey !p-28">
                <div className="space-y-8">
                    <h4>Nueva Zelanda tiene una conexión muy profunda con el medio ambiente; el
                        concepto de
                        kaitiakitanga,
                ...
                <div className="grid grid-cols-2 mt-8 gap-10">
                    <div>
                        <h2 className="mb-4 font-medium">Desarrollo de productos destacado</h2>
                    ...
                    <div>
                        <h2 className="mb-4 font-medium">Construido para durar</h2>
                    ...
                    <div>
                        <h2 className="mb-4 font-medium">Conseguí solo lo que necesitas</h2>
                    ...
                    <div>
                        <h2 className="mb-4 font-medium">Eliminación responsable de la batería</h2>
